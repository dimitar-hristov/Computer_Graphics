...
/*FREE CAMERA mode*/
	When the application is started the activa camera is free camera. With it the user can go around 
	the scene and explore the different graphics effect. In order to move the camera you have to 
